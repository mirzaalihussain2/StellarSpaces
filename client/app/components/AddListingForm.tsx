                ...
                {postcodeValidation ? (
                    ...
                    <>
                        ...
                        <Form.Item label="Number of bedrooms">
                            <InputNumber value={bedroomNumb} onChange={(value) => {
                                handleNumberInput(value, SetBedroomNumb)
                            }}/>
                        </Form.Item>
                        <Form.Item label="Number of bathrooms">
                            <InputNumber value={bathroomNumb} onChange={(value) => {
                                handleNumberInput(value, SetBathroomNumb)
                            }}/>
                        </Form.Item>
